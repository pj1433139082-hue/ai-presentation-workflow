...
- Ordinary titles, body copy, labels, numbers, and user data are `fill_slots`, never pixels in generated art.
...
| Concepts | `concepts/<slide-id>.png`, `concept-generation-log.json` | G4 contact sheet |
| Inventory + assets | `scene-graph.json`, `asset-manifest.json`, transparent PNGs | escalate exceptions only |
