...
Approval packet: reference contact sheet and analysis, same-content calibration comparison and selected variant, chosen reference IDs, composition/richness profile, style contract, anchor contact sheet, known image limitations, and the chosen direction.

The saved G3 packet covers reference selection, concept calibration, composition profile, visual direction, observable style rules, and the opening, typical, and highest-risk anchors.

## G4 — concept contact sheet

Ask the human to approve the entire deck at thumbnail/contact-sheet scale:
...
Approval packet: numbered contact sheet, a short change list, and a richness audit identifying any intentionally sparse pages. Component generation starts only after approval.

The saved G4 packet covers the full-deck contact sheet, slide-by-slide layout/richness review, blank table/chart regions, special-typography exceptions, and slide-specific deviations.
